...
<!--
2024-04-29: Great job on the lab! You have provided a detailed reflection on the lab, demonstrating a good understanding of the concepts covered. Note, however, that we did not cover some of the topics that you mentioned --be sure to review the lab content to ensure that you are accurately reflecting on the lab.
-->
...
<!--
2024-04-29: excellent summary of the lab. You have clearly articulated the key takeaways from the lab. You have also demonstrated a good understanding of the concepts covered in the lab.
-->
...
<!--
2024-04-29: Yes, it can be tricky. But note, we took the simulation-based approach, so model fitting (and the associated assumptions) were not necessary. This is a strength of the approach we took in this lab. We also did not consider effect size, outside of the confidence interval.
 -->
...
<!--
2024-04-29: Good to see that you are using a variety of resources to support your learning. This is a good strategy to deepen your understanding of the concepts covered in the lab.
 -->
...
<!--
2024-04-29: Great to see that you are interested in exploring more advanced topics in inferential analysis. These are all important areas to explore and will deepen your understanding of statistical modeling and data analysis.
-->
